...
builder.Services.AddTransient<IFilterPlatform, FilterPlatformService>();
builder.Services.AddTransient<IFilterDeveloper, FilterDeveloperService>();
builder.Services.AddTransient<IFilterGenre, FilterGenreService>();
